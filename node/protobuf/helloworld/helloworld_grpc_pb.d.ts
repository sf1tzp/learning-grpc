...
interface IGreeterService_ISayHelloAgain extends grpc.MethodDefinition<helloworld_helloworld_pb.HelloRequest, helloworld_helloworld_pb.HelloReply> {
...
export interface IGreeterServer extends grpc.UntypedServiceImplementation {
    ...
    sayHelloAgain: grpc.handleUnaryCall<helloworld_helloworld_pb.HelloRequest, helloworld_helloworld_pb.HelloReply>;
}
...
export interface IGreeterClient {
    ...
    sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
    sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
    sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
}
...
export class GreeterClient extends grpc.Client implements IGreeterClient {
    ...
    public sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
    public sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
    public sayHelloAgain(request: helloworld_helloworld_pb.HelloRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: helloworld_helloworld_pb.HelloReply) => void): grpc.ClientUnaryCall;
}
